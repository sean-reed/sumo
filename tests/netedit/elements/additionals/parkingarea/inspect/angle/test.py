...
netedit.modifyAttribute(netedit.attrs.parkingArea.inspect.angle, "dummyAngle", False)

# Change parameter Angle with a valid value (negative)
netedit.modifyAttribute(netedit.attrs.parkingArea.inspect.angle, "-6", False)

# Change parameter Angle with a valid value >360
netedit.modifyAttribute(netedit.attrs.parkingArea.inspect.angle, "500", False)

# Change parameter Angle with a valid value
netedit.modifyAttribute(netedit.attrs.parkingArea.inspect.angle, "32.5", False)
