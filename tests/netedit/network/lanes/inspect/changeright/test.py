...
netedit.modifyAttribute(netedit.attrs.lane.inspect.changeRight, "DummyAllowed", False)
...
netedit.modifyAttribute(netedit.attrs.lane.inspect.changeRight, "authority  army, passenger; taxi. tram", False)
