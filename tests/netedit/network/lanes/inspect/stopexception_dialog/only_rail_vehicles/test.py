...
netedit.modifyAttributeVClassDialog(netedit.attrs.lane.inspect.stopExceptionButton, netedit.attrs.dialog.allowVClass.onlyRailVehicles, False, disallowAll=False)
