...
netedit.modifyAttributeVClassDialog(netedit.attrs.connection.inspectSelection.changeRightButton,
                                    netedit.attrs.dialog.allowVClass.onlyRoadVehicles, False, disallowAll=False)
